...
class CreateSetActivity : AppCompatActivity(), CreateSetItemAdapter.OnIconClickListener {
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (result.isSuccessful) {
                    result.body()?.let {
                        this@CreateSetActivity.let { it1 ->
                        ...
                        val i = Intent(this@CreateSetActivity, MainActivity_Logged_In::class.java)
                    ...
                    result.errorBody()?.string()?.let {
                        this@CreateSetActivity.let { it1 ->
                            CustomToast(it1).makeText(
                                this@CreateSetActivity, it, CustomToast.LONG, CustomToast.ERROR
                            ).show()
                        }
                        Log.d("err", it)
                    }
                ...
                CustomToast(this@CreateSetActivity).makeText(
                    this@CreateSetActivity, e.message.toString(), CustomToast.LONG, CustomToast.ERROR
                ).show()
