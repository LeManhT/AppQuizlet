...
import com.example.appquizlet.databinding.FragmentMyStudySetBinding
import com.example.appquizlet.interfaceFolder.RVStudySetItem
import com.example.appquizlet.model.StudySetModel
import com.example.appquizlet.model.UserM
import com.example.appquizlet.ui.activities.CreateSetActivity
...
@AndroidEntryPoint
class FragmentMyStudySet : Fragment() {
    private lateinit var binding: FragmentMyStudySetBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyStudySetBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtCreateNewSet.setOnClickListener {
            val i = Intent(context, CreateSetActivity::class.java)
            startActivity(i)
        }
