...
import com.example.appquizlet.QuoteApplication
...
class CreateQuoteActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun showLoading(msg: String) {
        progressDialog = ProgressDialog.show(this@CreateQuoteActivity, null, msg)
    }
