...
import com.example.appquizlet.ui.fragments.FragmentLearnFlashCardSetting
...
class FlashcardLearn : AppCompatActivity(), OnClickButton, LearnFlashcardAdapter.onLearnCardClick,
    ...
    private lateinit var settingFragment: FragmentLearnFlashCardSetting
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settingFragment = FragmentLearnFlashCardSetting()
...
//                }
    ...
    override fun handleClickModeDisplay() {
        ...
        val btnToggleMode =
            settingFragment.dialog?.findViewById<LinearLayout>(R.id.layoutOrientation)
        val textOrientation =
            settingFragment.dialog?.findViewById<TextView>(R.id.textOrientation)
        if (isFront) {
            if (btnToggleMode != null) {
                if (textOrientation != null) {
                    textOrientation.text = resources.getString(R.string.term)
                }
                listCards.map {
                    it.isUnMark = false
                }
            ...
            if (btnToggleMode != null) {
                if (textOrientation != null) {
                    textOrientation.text = resources.getString(R.string.definition)
                }
                listCards.map {
                    it.isUnMark = true
                }
    ...
    override fun handleClickShuffle() {
        Log.d("ClickShuffle","Vao $isShuffle")
