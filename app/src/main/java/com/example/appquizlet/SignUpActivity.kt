...
//      Spannable text
        ...
        val termsOfServiceClickableSpan = object : ClickableSpan() {
            override fun onClick(widget: View) {
                ...
                Toast.makeText(this@SignUpActivity, "Bấm vào Terms of Services", Toast.LENGTH_SHORT).show()
        ...
        val privacyPolicyClickableSpan = object : ClickableSpan() {
            override fun onClick(widget: View) {
                ...
                Toast.makeText(this@SignUpActivity, "Bấm vào Privacy Policy", Toast.LENGTH_SHORT).show()
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (result.isSuccessful) {
                    ...
                    startActivity(intent)
                    CustomToast(this@SignUpActivity).makeText(
                        this@SignUpActivity,
                        msgSignInSuccess,
                        CustomToast.LONG,
                        CustomToast.SUCCESS
